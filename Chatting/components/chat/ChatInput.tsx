            ...
            <FormItem>
              <FormControl>
                <div className="relative p-4 pb-6">
                  ...
                  >
                    <Plus className="text-white dark:text-[#0f1117]" />
                  </button>
                  <Input
                    disabled={isLoading}
                    className="px-14 py-6 bg-zinc-200/90 dark:bg-[#13151c]/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
                    placeholder={`Message ${
