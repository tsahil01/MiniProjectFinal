      ...
      <DialogContent className="bg-white text-black p-0 overflow-hidden w-full sm:w-auto max-sm:h-full">
        <DialogHeader className="pt-8 px-6">
          <DialogTitle className="text-[22px] text-left font-bold">
            Customize Your <span className="text-[#ff7000]">ThisCode</span>{" "}
            Server
          </DialogTitle>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <DialogFooter className="bg-gray-100 px-6 py-4">
              <Button disabled={isLoading} style={{ background: 'linear-gradient(129deg, #ff7000 0%, #e2995f 100%)' }} variant="primary">
                Create
              </Button>
            </DialogFooter>
          </form>
